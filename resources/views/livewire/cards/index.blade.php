<div>
    <x-slot name="header">
        <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Tipos de Tarjeta </h5>
    </x-slot>

    <x-slot name="toolbar">
        <div class="d-flex align-items-center">
            <a href="{{ route('cards.create') }}" class="btn btn-primary font-weight-bolder">
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">
                            <span class="text-muted pt-2 font-size-sm d-block">Maestro para registrar y actualizar el catálogo de productos.</span>
                        </h3>
                    </div>
                </div>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-right" style="width: 150px;">Comisión</th>
                            ...
                            <tbody>
                                @forelse ($items as $item)
                                    <tr>
                                        ...
                                        <td class="text-right">{{ $item->comission_formatted }}</td>
                                            ...
                                            <div class="dropdown dropdown-inline">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                    <ul class="navi flex-column navi-hover py-2">
                                                        ...
                                                        <li class="navi-item">
                                                            <a href="{{ route('cards.edit', $item->id) }}" class="navi-link">
