...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
    ...
    <script src="{{ asset('metronic/js/jquery.maskMoney.js') }}"></script>
    ...
    <script>
        window.addEventListener('submitted', event => {
            Swal.fire({
                ...
                location.href = event.detail.route;
            });
        });
        ...
        window.addEventListener('toast', event => {
            $.notify(event.detail.message, { type: event.detail.type });
        });
        ...
        function initAll() {
            ...
            //  InputMask Phone
            $(".kt-phonemask").inputmask("mask", {
                "mask": "(999) 9999-9999",
                placeholder: ""
            });
            //  InputMask Alfa-Numerico
            $(".kt-alpha-num").inputmask("mask", {
                "mask": "*",
                "repeat": "*",
                placeholder: ""
            });
